...
class MainService : Service(), DataSynchronization {
    ...
    } // START_STICKY = If our service is killed by the system or we kill the app the service belongs to, it will start again.

    override fun onBind(p0: Intent?): IBinder {
        Log.v(tag, "[ ON BIND ]")
        return binder
    } /*- IBinder = This is used by the clients to communicate with the service
        - The 'onBind()' method returns an instance of 'binder' that is produced by calling the 'getServiceBinder()' method
         */
...
/*
NOTE: All important lifecycle methods are overridden (see above)

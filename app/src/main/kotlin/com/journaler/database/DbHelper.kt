...
/*
- Now we will describe our database
- This 'helper' class is responsible for DATABASE INITIALIZATION
- The DB helper class must extend Androids ' SQLiteOpenHelper' class.
